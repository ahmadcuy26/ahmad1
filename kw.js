...
✅ WAJIB MENGGUNAKAN JASA ADMIN *ZIRO* SUPAYA TERHINDAR DARI PENIPUAN  !
✅ BE SMART BUYYER`
reply(teks938)
}
break
case "payment": {
teks137 = "*🔰PAYMENT DaffBotz⚡*\n```SEMUA PEMBAYARAN\nWAJIB MENYERTAKAN BUKTI TRANSFER !!```\n*_( ALL TRX NO REFF‼️ )_*\n\n*• GOPAY 💳 :* _081295532922\n```( ATAS NAMA: DAFFBOTZ )```\n\n*• DANA 💳 :*```081295532922\n( ATAS NAMA: IYU******WATI )```\n\n*• OVO 💳 :*```081295532922\n( ATAS NAMA: ABDUL DAFFI AL AWAL )```\n\n*• SHOPPE PAY 💳 :*```081295532922\n( ATAS NAMA: IYU*****WATI )```\n\n*• QRIS 💳 :*_('./qris.jpg')_\n```( ATAS NAMA: JB SPEED )```\n\n*© DaffBotz ⚡*"
reply(teks137)
}
break
case "donasi": {
...
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕
         ❨ *DaffBotzl* ❩`
client.sendMessage(from, { image: { url: "https://telegra.ph/file/2c10797e2b046bb532d1c.jpg" }, caption: teks28 }, { quoted: msg })
}
break
case "sewa": {
teks91 = `◎ © Hay Kak @${sender.split("@")[0]}
Sewa Bot ? Hubungi Admin Untuk Nego Wa.me/6281228070013`

...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By DaffBotz", "Dekstop", "3.0"]})
console.log(color('[ SC BY DaffBotz ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : DaffBotz\n➸ Creator : DAFF\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : DaffBotz`\n➸ My Instagram : @egarpcn\n\nDonase Me For Support :\n➸ DONASI : 081295532922\n\nThanks\n', 'red'))
...
sendMessage(`6281295532922@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
